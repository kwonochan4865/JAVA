...
public class NonBufferVsBufferExample15 {

	public static void main(String[] args) throws Exception {
		String originalFilePath1 =
				NonBufferVsBufferExample15.class.getResource("originalFile1.jpg").getPath();
		String targetFilePath1 = "C:/Temp/targetFile1.jpg";
		FileInputStream fis = new FileInputStream(originalFilePath1);
		FileOutputStream fos = new FileOutputStream(originalFilePath1);
////////////////////////////////////////////////////////////////////////////////////////////// 기본 스트림 생성
		String originalFilePath2 =
				NonBufferVsBufferExample15.class.getResource("originalFile2.jpg").getPath();
